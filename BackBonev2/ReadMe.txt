========================================================================
       MICROSOFT FOUNDATION CLASS BIBLIOTHEK : BackBone
========================================================================


Diese BackBone-Anwendung hat der Klassen-Assistent für Sie erstellt. Diese Anwendung
...
Ihre BackBone-Anwendung bilden.
...
res\BackBone.ico
	...
	Symbol wird durch die Haupt-Ressourcendatei BackBone.rc eingebunden.
...
BackBoneDlg.h, BackBoneDlg.cpp - das Dialogfeld
    	Diese Dateien enthalten die Klasse CBackBoneDlg. Diese Klasse legt das
    	Verhalten des Haupt-Dialogfelds der Anwendung fest. Die Vorlage des Dialog-
	felds befindet sich in BackBone.rc, die mit Microsoft Visual C++
...
StdAfx.h, StdAfx.cpp
	...
	BackBone.pch und eine vorkompilierte Typdatei mit der Bezeichnung StdAfx.obj
	erstellt.
